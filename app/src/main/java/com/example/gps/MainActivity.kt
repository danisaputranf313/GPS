...
class MainActivity : AppCompatActivity() {
        ...
        REQUEST_CODE ->{
            if(grantResults.size > 0)
            {
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED)
                    ...
                    Toast.makeText(this@MainActivity, "Permition denied",
                        Toast.LENGTH_SHORT)
                        .show()
            }
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        else
        {
            ...
            // set event
            btn_Start_Up.setOnClickListener(View.OnClickListener {
                ...
                fusedLocationProviderClient.requestLocationUpdates(locationRequest,locationCallback,Lopper.myLooper())
                //Merubah status tombol
                btn_Start_Up.isEnabled = !btn_Start_Up.isEnabled
     ...
     private fun buildLocationCallBack(){
         locationCallback = object :LocationCallback(){
             ...
             override fun onLocationResult(p0: LocationResult?){
                 ...
                 //get last location
                 txt_location.text =
                         location.latitude.toString()+"/"+location.longtitude.toString()
             }
        }
    }
    private fun buildLocationRequest(){
        ...
        locationRequest.smallesDisplacement = l0f
    }
}
